...
namespace CWJ.YU.Mobility
{
    ...
    public class RotateObjByDrag : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, INeedSceneObj
    {
        ...
        {
            mousePos = (worldCanvas == null || worldCanvas.renderMode == RenderMode.WorldSpace ?
                mousePos.CanvasToWorldPos_WorldSpaceRenderMode(playerCamera, worldCanvas)
                : mousePos.CanvasToWorldPos_ScreenSpaceRenderMode(playerCamera, worldCanvas));
            return mousePos;
        }
