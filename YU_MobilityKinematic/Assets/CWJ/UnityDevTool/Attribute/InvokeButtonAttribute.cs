...
namespace CWJ
{
    ...
    public class InvokeButtonAttribute : Attribute
    {
        ...
        public InvokeButtonAttribute(bool isNeedUndoNSave = false, string onMarkedBoolName = null, bool isOnlyButton = true, string displayName = null, string tooltip = null, string aboveFieldName = null)
        {
