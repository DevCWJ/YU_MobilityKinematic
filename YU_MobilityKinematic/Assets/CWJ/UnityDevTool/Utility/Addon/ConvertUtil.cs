...
namespace CWJ
{
    public static class ConvertUtil
    {
        ...
        #endregion "Object Only odd prims, TODO"
        ...
        public static string ToString(bool value, bool isToNumber = false)
        {
             return isToNumber? (value ? "1" : "0") : System.Convert.ToString(value);
        }
        ...
        {
            int bitCnt = bits.Count;
            int numBytes = (int)System.Math.Ceiling(bitCnt / 8.0f);
		...
		/// <summary>
		/// 게임 오브젝트의 구성 요소간에 캐스팅 할 수있는 고유 한 캐스팅 루틴
		/// 게임 오브젝트를 컴포넌트로 취급가능
		/// </summary>
