...
namespace CWJ
{
    public static class StringUtil
    {
        ...
        public static string ConvertToDecimalLength(float @decimal, int leftLength = 3, int rightLength = 6)
        {
            string[] result = new string[2];
            result[0] = string.Format("{0:D" + leftLength + "}", int.Parse(@decimal.ToString().Split(".")[0]));
            result[1] = string.Format("{0:F" + rightLength + "}", @decimal).Split(".")[1];
        ...
        {
            return ReplaceEnd(str, removeStr, "", stringComparison);
        }
