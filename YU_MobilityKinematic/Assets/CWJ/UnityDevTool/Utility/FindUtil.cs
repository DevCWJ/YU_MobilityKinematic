...
namespace CWJ
{
    public static class FindUtil
    {
        ...
        public static T[] FindObjectsOfType_New<T>(bool includeInactive, bool includeDontDestroyOnLoadObjs, Predicate<T> predicate = null) where T : UnityObject
        {
            ...
            {
                return (FindObjectsOfType_New<Transform>(includeInactive, includeDontDestroyOnLoadObjs).ConvertAll(t => t.gameObject).FindAll(predicate as Predicate<GameObject>) as T[]);                
            }
        ...
        public static T GetOrAddComponent<T>(this GameObject gameObject) where T : Component
        {
            ...
            if (comp != null) return comp;
            else return comp = gameObject.AddComponent<T>();
        }
        ...
        public static Component GetOrAddComponent(this GameObject gameObject, Type type)
        {
            ...
            if (comp == null) return gameObject.AddComponent(type);
            else return comp;
        }
        ...
        public static void GetAndRemoveComponent<T>(this GameObject gameObject) where T : Component
        {
            ...
            T comp = gameObject.GetComponent<T>();
            if (comp != null) Component.Destroy(comp);
        }
