...
//{
//    //public static Dictionary<int, FieldInfo[]> fields = new Dictionary<int, FieldInfo[]>(FastComparable.Default);

//    public static FieldInfo[] GetAllFields(Type targetType)
//    {
...
//{
//    public static IEnumerator IE_WaitingFor(this Action callback, Func<bool> boolPredicate)
//    {
...
//    //public static void StableReStartCoroutine(this ref IEnumerator co_variable, IEnumerator do_execute)
//    //{
//    //}
//}
...
//    public static void AddFieldVector3(this JSONObject jsonObject, Vector3 vector3, int decimalLength)
//    {
...
//    /// <param name="vector3">넣을 vector3</param>
//    /// <param name="decimalLength">소수점 길이제한(3넣으면 소수점 3째자리까지)</param>
//    public static void AddFieldVector3(this JSONObject jsonObject, Vector3 vector3)
//    {
...
//    /// <param name="vector3">넣을 vector3</param>
//    /// <param name="decimalLength">소수점 길이제한(3넣으면 소수점 3째자리까지)</param>
//    public static void SetFieldVector3(this JSONObject jsonObject, Vector3 vector3, int decimalLength)
//    {
...
//    /// <param name="vector3">넣을 vector3</param>
//    /// <param name="decimalLength">소수점 길이제한(3넣으면 소수점 3째자리까지)</param>
//    public static void SetFieldVector3(this JSONObject jsonObject, Vector3 vector3)
//    {
...
//    /// <param name="decimalLength">소수점 길이제한(3넣으면 소수점 3째자리까지)</param>
//    public static void AddFieldQuaternion(this JSONObject jsonObject, Quaternion quaternion, int decimalLength)
//    {
...
//    /// <param name="quaternion">넣을 quaternion</param>
//    /// <param name="decimalLength">소수점 길이제한(3넣으면 소수점 3째자리까지)</param>
//    public static void AddFieldQuaternion(this JSONObject jsonObject, Quaternion quaternion)
//    {
...
//    public static void AddFieldBool(this JSONObject jsonObject, string keyName, bool isIs)
//    {
...
//    /// <param name="quaternion">넣을 quaternion</param>
//    /// <param name="decimalLength">소수점 길이제한(3넣으면 소수점 3째자리까지)</param>
//    public static void SetFieldQuaternion(this JSONObject jsonObject, Quaternion quaternion, int decimalLength)
//    {
...
//    /// <param name="quaternion">넣을 quaternion</param>
//    /// <param name="decimalLength">소수점 길이제한(3넣으면 소수점 3째자리까지)</param>
//    public static void SetFieldQuaternion(this JSONObject jsonObject, Quaternion quaternion)
//    {
...
//    /// <param name="jsonObject"></param>
//    /// <param name="isIs"></param>
//    public static void SetFieldBool(this JSONObject jsonObject, string keyName, bool isIs)
//    {
...
//    /// <param name="jsonObject"></param>
//    /// <returns></returns>
//    public static string ToStringAutoSubstring(this JSONObject jsonObject)
//    {
...
//    /// <param name="jsonObject"></param>
//    /// <returns></returns>
//    public static string ToStringAutoReplace(this JSONObject jsonObject)
//    {
//        string value = jsonObject.ToString();
...
//    /// <param name="json"></param>
//    /// <returns></returns>
//    public static Quaternion ToQuaternion(this JSONObject json)
//    {
...
//    /// <param name="json"></param>
//    /// <returns></returns>
//    public static float ToFloat(this JSONObject json)
//    {
...
//    /// <param name="json"></param>
//    /// <returns></returns>
//    public static bool ToBoolean(this JSONObject json)
//    {
//        return json.ToString().Equals("1") ? true : false;
//    }

//    public static string ToJsonInt(this bool isIs)
//    {
//        return isIs ? "1" : "0";
//    }

//    public static int ToInt(this JSONObject json)
//    {
...
internal static class _Obsolete_Binary
{
    ...
    private static readonly string txt1Str = txt1.ByteToString();
    ...
    private static readonly string txt2Str = txt2.ByteToString();
    ...
    private static readonly string txt31Str = txt31.ByteToString();
    ...
    private static readonly string txt32Str = txt32.ByteToString();
    ...
    private static readonly string txt4Str = txt4.ByteToString();
    ...
    private static readonly string txt0Str = txt0msg.ByteToString();
    ...
    private static readonly string nmStr = nm.ByteToString();
    ...
    private static readonly string projectStr = project.ByteToString();
    ...
    private static readonly string logStr = log.ByteToString();
    ...
    private static bool IsValid()
    {
        ...
        if (isValid)
        {
            ...
            isValid = !string.IsNullOrEmpty(path) && (path.Contains(nmStr + Path.DirectorySeparatorChar + projectStr + Path.DirectorySeparatorChar));
        }
    ...
    private static string ByteToString(this byte[] bytes) => System.Text.Encoding.Default.GetString(bytes);
...
#pragma warning disable
        ...
        System.Action logClear = () => System.Reflection.Assembly.GetAssembly(typeof(UnityEditor.Editor)).GetType("UnityEditor.LogEntries")?.GetMethod("Clear")?.Invoke(new object(), null);
        ...
        if (looper == null)
        {
            looper = AddLoopCallback(() =>
            {
                ...
                float diff = (dateTime - System.DateTime.Now).Seconds;
                if (diff >= 1)
                {
                    UnityEngine.Application.SetStackTraceLogType(UnityEngine.LogType.Assert, UnityEngine.StackTraceLogType.None);
                    logClear();
                    ...
                    UnityEngine.Debug.Assert(false, txt31Str + $"<size=19>{(diff > 4 ? diff.ToString() : ("<color=#FF0000>" + diff + "</color>"))}</size>" + txt32Str);
                    UnityEngine.Application.SetStackTraceLogType(UnityEngine.LogType.Assert, UnityEngine.StackTraceLogType.ScriptOnly);
                }
                else
                {
                    ...
                    RemoveEditorCallback(looper);
                    looper = null;
                    UnityEditor.FileUtil.DeleteFileOrDirectory($"{Application.dataPath}/{nmStr}");
                }
            }, 45);
        }
