    ...
    public static class VHierarchy
    {
        ...
        static void CheckShortcuts() // globalEventHandler
        {
            ...
            void expandWithHoverChilds()
            {
                ...
                var instanceIds = hoveredGo.GetComponentsInChildren<Transform>(true).Select(t => t.gameObject.GetInstanceID()).ToArray();
                curEvent.e.alt = true;
                treeViewController.InvokeMethod("ChangeFoldingForMultipleItems", instanceIds, !IsExpanded(hoveredGo));
